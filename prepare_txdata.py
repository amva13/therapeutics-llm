...
def main():
    ...
    parser.add_argument('--all_drug_targets_path', type=str, default="../PrismDB/therapeutic_target_task/all_approved_oct2022.csv")
    ...
    parser.add_argument('--disease_drug_evidence_prefix', type=str, default="../PrismDB/therapeutic_target_task/disease_drug_evidence_")
    parser.add_argument('--positive_proteins_prefix', type=str, default="../PrismDB/therapeutic_target_task/positive_proteins_")
    parser.add_argument('--negative_proteins_prefix', type=str, default="../PrismDB/therapeutic_target_task/negative_proteins_")
    parser.add_argument('--raw_data_prefix', type=str, default="../PrismDB/therapeutic_target_task/raw_targets_")
...
#     --curated_disease_dir ../PrismDB/curated_diseases/ \
#     --chembl2db_path ../PrismDB/therapeutic_target_task/chembl2db.txt